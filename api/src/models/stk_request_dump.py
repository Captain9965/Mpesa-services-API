...
class StkRequestDump(db.Model):
    ...
    resultDesc = db.Column(db.String(150), nullable=False, default="unreconciled")
    ...
    def serialize(self):
        return {
            ...
            "request status": "success" if self.requestStatus is True else "Fail",
            "service status": "success" if self.serviceStatus is True else "Fail",
